...
def load_auth():
    # Use the absolute path or correct relative path to the auth.json file
    FILE = os.path.join("C:\\Users\\User\\Desktop\\200 PYTHON PROJECT CHALLENGE\\data\\Day67\\Price-Tracking-Web-Scraper\\Backend\\scraper", "auth_example.json")
    try:
        ...
        print(f"Error: {FILE} file not found. Please ensure it exists.")
        exit(1)
